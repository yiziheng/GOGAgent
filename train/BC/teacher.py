...
ACTION_RESCUE_GUIDE = (
    ...
    "- UP: upgrades the last atomic node into a stronger type-specific subgraph. "
    "Solver UP becomes PlanSketch -> Solver. Use it when the basic solver likely "
    "failed from insufficient reasoning depth.\n"
